...
namespace Model
{
    public class SampleData
    {
        ...
        {
            public static readonly User TesterTim = new User("Tim Trotter", EUserType.Tester);
            public static readonly User TesterTara = new User("Tara Tutu", EUserType.Tester);
            public static readonly User DeveloperDeborah = new User("Deborah Denton", EUserType.Developer);
            public static readonly User DeveloperDarren = new User("Darren Dahlia", EUserType.Developer);
            public static readonly User ManagerMary = new User("Mary Malcop", EUserType.Manager);
            public static readonly User CustomerColin = new User("Colin Carton", EUserType.Customer);
        }
